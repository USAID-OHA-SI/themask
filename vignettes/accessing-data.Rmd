...
remotes::install_github("USAID-OHA-SI/gophr", quiet = TRUE)
remotes::install_github("USAID-OHA-SI/glamr", quiet = TRUE)
remotes::install_github("USAID-OHA-SI/glitr", quiet = TRUE)
